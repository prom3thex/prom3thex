...
- `prom3thex-banner.webp` — 1600 × 450 WebP, used by all three profile READMEs. Derived from `ChatGPT Image 12. Aug. 2026, 03_50_30 (1).png` by cropping and resizing the portrait, extending the supplied background with a blurred crop, applying restrained tonal grading, feathering the source boundary, and adding minimal geometric accents.
